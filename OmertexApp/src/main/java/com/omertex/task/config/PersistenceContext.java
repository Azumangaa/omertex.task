...
@EnableJpaRepositories(basePackages = {
        "com.omertex.task.topic.repository",
        "com.omertex.task.inquiry.repository",
        "com.omertex.task.customer.repository",
...
public class PersistenceContext {
    ...
    private static final String[] PROPERTY_PACKAGES_TO_SCAN = {
            "com.omertex.task.common.model",
            "com.omertex.task.topic.model",
            "com.omertex.task.inquiry.model",
            "com.omertex.task.inquiry.attribute.model",
            "com.omertex.task.customer.model"
    };
